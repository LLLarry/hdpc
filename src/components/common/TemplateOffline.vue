    ...
    <div class="templateOffline">
        <el-card :class="['box-card','temTableTitle', (from==3 && item.isSelected==1) ? 'selectedTem' : '']" v-for="(item,i) in arr" :key="i">
           <el-table
            ...
            >
            <template slot-scope="scope">
               <div v-if="scope.row.edit"> <el-input size="mini" v-model="childTemForm.remark" style="width: 85%;margin-right: 10px;" placeholder="请输入充卡金额"></el-input>元</div>
            ...
            <template slot-scope="scope">
             ...
             <div style="margin-top: 20px; text-align: center" class="clearfix"  v-if="from==1">
              ...
              <div style="margin-top: 20px; text-align: center" class="clearfix"  v-else-if="from==2">
                <el-button type="primary" size="mini" @click="$router.push({path: '/deviceManage/deviceList/templateDetail',query: {hw: '04'}})" style="float:left;margin-left: 30%;">查看更多</el-button>
